...
<body>
    ...
    <aside class="sidebar glass">
        <div class="logo">
            <i class="fa-solid fa-shield-halved"></i> Guard User
        </div>
        ...
        <header class="topbar">
            ...
            <div class="topbar-right">
                ...
                <div class="profile-menu">
                    <div class="avatar">{{ substr(auth()->guard('web')->user()->name ?? 'U', 0, 1) }}</div>
                    <div style="margin-right: 15px;">
                        <div style="font-weight: 600; font-size: 0.95rem;">{{ auth()->guard('web')->user()->name ?? 'User' }}</div>
                        <div style="color: var(--text-secondary); font-size: 0.8rem;">User</div>
                    </div>
                </div>
