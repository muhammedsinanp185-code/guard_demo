...
@section('content')
    <div class="page-header">
        ...
        <a href="{{ route('admin.users.index') }}" class="btn" style="border: 1px solid var(--border-color); color: var(--text-primary);">
    ...
    <div class="form-container glass" style="margin-top: 30px;">
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" required placeholder="e.g. jane@example.com">
            </div>
